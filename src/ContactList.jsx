...
const ContactList = ({ List,setList,fetch}) => {
    ...
    const handleUpdate=(uid,name,number,email)=>
    {
        console.log(name);
        var updname=prompt("Enter your Name to be updated:",name);
        var updphone=prompt("Enter your PhNum to be updated:",number);
        var updmail=prompt("Enter your Mail to be updated:",email);
                    ...
                    <table class="table">
                        ...
                        List.map((i) => {
                            return (<tr key={i._id}>  
                                ...
                                <button onClick={handleUpdate.bind(this,i._id,i.Name,i.Phone,i.Email)}>Update</button>
                                </tr>
                                )
                        })
                    }
